  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass rounded-[2.5rem] p-8 border border-white/5 bg-white/5 shadow-xl">
        ...
        <p className="mt-8 text-[9px] text-slate-600 text-center font-bold uppercase tracking-[0.2em]">Formula verified: Monthly / {workingDaysLabel} + (OT × OT Rate) - Absents</p>
      </div>
    </div>
  );
};
