...
// Import calculateWorkedHours instead of calculateHours to match utils logic
  ...
  const handleQuickPunch = () => {
    ...
    if (!isPunchedIn) {
      ...
      if (existing && existing.checkIn) {
        // Fix: Use calculateWorkedHours to correctly account for mandatory lunch break
        const workedHours = calculateWorkedHours(existing.checkIn, timeStr);
        // Fix: getOT only expects 1 argument (workedHours)
