...
import { calculateWorkedHours, getOT, getAutoStatus, toLocalDateString, formatTime12h } from '../utils.ts';
...
const Calendar: React.FC<Props> = ({ employee, records, holidays, onAddRecord, onDeleteRecord }) => {
  ...
  const handleDelete = () => {
    if (selectedDate && window.confirm(`Permanently delete entry for ${selectedDate}?`)) {
