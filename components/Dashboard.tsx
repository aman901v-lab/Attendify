    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-3xl p-6 border border-white/5 bg-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          <div>
            <p className="text-[10px] text-slate-500 font-bold uppercase">Fixed Monthly (26 Days)</p>
        ...
        <p className="mt-6 text-[9px] text-slate-500 text-center font-medium uppercase tracking-widest italic">Note: Salary calculation is fixed by admin and based on 26 working days.</p>
      </div>
    </div>
  );
};
