          ...
          <table className="w-full text-left">
            <thead className="bg-white/5 border-b border-white/5">
              <tr>
                ...
                <th className="px-5 py-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">Punching</th>
                ...
                <th className="px-5 py-4 text-[9px] font-black text-slate-500 uppercase tracking-widest text-right">Earning ₹</th>
              </tr>
            </thead>
            ...
            <table className="w-full text-left border-collapse border border-slate-300 mb-8">
                <thead>
                    <tr className="bg-slate-100">
                      ...
                      <th className="py-2 px-3 border border-slate-300 text-[10px] font-black uppercase text-right">Day Pay ₹</th>
                    </tr>
                </thead>
                <tbody>
                    {monthlyRecords.map(r => {
