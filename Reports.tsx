        ...
        <div className="max-w-[210mm] mx-auto bg-white min-h-[297mm]">
            ...
            <div className="flex justify-between items-start border-b-2 border-slate-900 pb-8 mb-10">
               ...
               <div className="text-right">
                  ...
                  <p className="text-[8px] text-slate-400 font-bold mt-1">Generated on: {new Date().toLocaleDateString('en-GB').replace(/\//g, '-')}</p>
               </div>
            </div>
                        ...
                        {monthlyRecords.map(r => {
                          ...
                          return (
                              <tr key={r.date} className="hover:bg-slate-50 transition-colors">
                                <td className="py-2.5 px-4 text-[10px] font-mono font-bold text-slate-500">{formatDate(r.date)}</td>
            ...
            <div className="grid grid-cols-2 gap-8 pt-8 border-t-2 border-slate-900">
                <div className="space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-slate-100 rounded-xl border border-dashed border-slate-300">
                      <p className="text-[9px] text-slate-500 font-bold italic">Note: Salary calculation based on a {employee.workingDaysPerMonth || 26}-day cycle. OT is calculated at {stats.appliedOTRate || (employee.monthlySalary / (employee.workingDaysPerMonth || 26) / 8).toFixed(0)} INR per hour.</p>
                    </div>
                </div>
